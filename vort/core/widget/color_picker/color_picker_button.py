...
from core.widget.color_picker.color_picker_button_ui import ColorPickerButtonUI
...
class ColorPickerButtonFilter(QObject):
...
class ColorPickerButton(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.ui: ColorPickerButtonUI = ColorPickerButtonUI(parent)
        ...
        self.mouse_filter: ColorPickerButtonFilter = ColorPickerButtonFilter()
