...
class FooterSettingsContext:
    ...
    def alignmentName(flag: Qt.AlignmentFlag) -> str:
        return FooterSettingsContext.ALIGNMENT_NAMES[FooterSettingsContext.ALIGNMENT_FLAGS.index(flag)]

    @staticmethod
    def alignmentFlag(name: str) -> Qt.AlignmentFlag:
        return FooterSettingsContext.ALIGNMENT_FLAGS[FooterSettingsContext.ALIGNMENT_NAMES.index(name)]


class FooterSettings(QScrollArea):
    def __init__(self, context: FooterSettingsContext, parent: QWidget | None = None) -> None:
        ...
        self.alignment_combo_box.addItems(FooterSettingsContext.ALIGNMENT_NAMES)
        self.alignment_combo_box.setCurrentIndex(FooterSettingsContext.ALIGNMENT_FLAGS.index(context.alignment))
