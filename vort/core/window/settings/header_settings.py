...
class HeaderSettingsContext:
    ...
    def __init__(self) -> None:
        ...
        self.text_background_color: QColor = QColor()
        self.text_foreground_color: QColor = QColor()

        self.is_first_page_included: bool = False

        self.is_pagination_turned: bool = False
        self.pagination_starting_number: int = 1
    ...
    def alignmentName(flag: Qt.AlignmentFlag) -> str:
        return HeaderSettingsContext.ALIGNMENT_NAMES[HeaderSettingsContext.ALIGNMENT_FLAGS.index(flag)]

    @staticmethod
    def alignmentFlag(name: str) -> Qt.AlignmentFlag:
        return HeaderSettingsContext.ALIGNMENT_FLAGS[HeaderSettingsContext.ALIGNMENT_NAMES.index(name)]


class HeaderSettings(QScrollArea):
    def __init__(self, context: HeaderSettingsContext, parent: QWidget | None = None) -> None:
        super().__init__(parent)

        self.context: HeaderSettingsContext = context
        ...
        self.alignment_combo_box.addItems(HeaderSettingsContext.ALIGNMENT_NAMES)
        self.alignment_combo_box.setCurrentIndex(HeaderSettingsContext.ALIGNMENT_FLAGS.index(context.alignment))
        ...
        self.foreground_color_red_spin_box.setValue(self.context.text_foreground_color.red())
        ...
        self.foreground_color_green_spin_box.setValue(self.context.text_foreground_color.green())
        ...
        self.background_color_red_spin_box.setValue(self.context.text_background_color.red())
        ...
        self.background_color_green_spin_box.setValue(self.context.text_background_color.green())
        ...
        self.first_page_check_box.setChecked(not self.context.is_first_page_included)
        ...
        self.starting_number_spin_box.setValue(self.context.pagination_starting_number)
