...
class FooterEditor(QObject):
    repaintRequest: Signal = Signal()

    def __init__(self, context: FooterDocumentContext, parent: QWidget | None = None) -> None:
        super().__init__(parent)

        self.__context: FooterDocumentContext = context
    ...
    def context(self) -> FooterDocumentContext:
