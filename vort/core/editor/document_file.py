...
class DocumentFile:
    def __init__(self) -> None:
        ...
        self.is_header_first_page_included: bool = False
        ...
        self.is_footer_first_page_included: bool = False
    ...
    def default_file(cls) -> Self:
        ...
        file.is_header_first_page_included = True
        ...
        file.is_footer_first_page_included = True
