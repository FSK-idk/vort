...
class DataBase(QObject):
    ...
    def insertStyle(self, style_data: StyleData) -> None:
        ...
        query.bindValue(":is_font_changed", 1 if style_data.is_font_changed else 0)
        ...
        query.bindValue(":is_bold", 1 if style_data.is_bold else 0)
        query.bindValue(":is_italic", 1 if style_data.is_italic else 0)
        query.bindValue(":is_underlined", 1 if style_data.is_underlined else 0)
        query.bindValue(":is_paragraph_changed", 1 if style_data.is_paragraph_changed else 0)
        query.bindValue(
